 ...
 */
export class SceneControls extends Controls<EventMap> {
  state = State.NONE;
   ...
   */
  constructor(object: Object3D, domElement = null) {
  ...
  update(deltaTime = null) {
    ...
    if (
      ...
      this._lastTargetPosition.distanceToSquared(this.target) > EPS
    ) {
      this.dispatchEvent(_changeEvent);
