...
import type {
  ...
  PropertyValue,
  SetValue,
} from "../properties/TaggedProperty";
  ...
  if (tag.legacyData) {
    invariant(
      reader.fileVersionUE5 <
        EUnrealEngineObjectUE5Version.PROPERTY_TAG_COMPLETE_TYPE_NAME,
    );
    if (
...
export function getPropertySerializer(
  ...
  if (propertyType == EPropertyType.MapProperty) {
    return getMapSerializer(
      typeName.getParameter(0),
      typeName.getParameter(1),
      fileVersionUE5,
    );
  }
...
function softObjectPathSerializer(
  reader: AssetReader,
  resolver: ObjectResolver,
): PropertyValue {
  const object = resolver(reader);
  const objectPath = object
    ? FSoftObjectPath.fromObject(object)
...
const readerByStructName = new FNameMap<StructPropertySerializer>([
  // Vector2
  [
    makeCombinedName(NAME_CoreUObject, "Vector2f"),
    makeStructReader(FVector2.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Vector2d"),
    makeLargeWorld(FVector2.fromFloat, FVector2.fromDouble),
  ],

  // Vector3
  [
    makeCombinedName(NAME_CoreUObject, "Vector3f"),
    makeStructReader(FVector3.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Vector3d"),
    makeLargeWorld(FVector3.fromFloat, FVector3.fromDouble),
  ],
  [
  ...
  // IntPoint / UintPoint
  [
    makeCombinedName(NAME_CoreUObject, "Int32Point"),
    makeStructReader(FVector2.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Int64Point"),
    makeStructReader(FVector2.fromInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint32Point"),
    makeStructReader(FVector2.fromUInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint64Point"),
    makeStructReader(FVector2.fromUInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "IntPoint"),
    makeStructReader(FVector2.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "UintPoint"),
    makeStructReader(FVector2.fromUInt32),
  ],

  // IntVector2 / UintVector2
  [
    makeCombinedName(NAME_CoreUObject, "Int32Vector2"),
    makeStructReader(FVector2.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Int64Vector2"),
    makeStructReader(FVector2.fromInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint32Vector2"),
    makeStructReader(FVector2.fromUInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint64Vector2"),
    makeStructReader(FVector2.fromUInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "IntVector2"),
    makeStructReader(FVector2.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "UintVector2"),
    makeStructReader(FVector2.fromUInt32),
  ],

  // IntVector / UintVector
  [
    makeCombinedName(NAME_CoreUObject, "Int32Vector"),
    makeStructReader(FVector3.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Int64Vector"),
    makeStructReader(FVector3.fromInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint32Vector"),
    makeStructReader(FVector3.fromUint32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint64Vector"),
    makeStructReader(FVector3.fromUint64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "IntVector"),
    makeStructReader(FVector3.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "UintVector"),
    makeStructReader(FVector3.fromUint32),
  ],

  // IntVector4 / UintVector4
  [
    makeCombinedName(NAME_CoreUObject, "Int32Vector4"),
    makeStructReader(FVector4.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Int64Vector4"),
    makeStructReader(FVector4.fromInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint32Vector4"),
    makeStructReader(FVector4.fromUInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Uint64Vector4"),
    makeStructReader(FVector4.fromUInt64),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "IntVector4"),
    makeStructReader(FVector4.fromInt32),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "UintVector4"),
    makeStructReader(FVector4.fromUInt32),
  ],

  // Vector4
  [
    makeCombinedName(NAME_CoreUObject, "Vector4f"),
    makeStructReader(FVector4.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Vector4d"),
    makeLargeWorld(FVector4.fromFloat, FVector4.fromDouble),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Vector4"),
    makeLargeWorld(FVector4.fromFloat, FVector4.fromDouble),
  ],

  // Plane4
  [
    makeCombinedName(NAME_CoreUObject, "Plane4f"),
    makeStructReader(FPlane.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Plane4d"),
    makeLargeWorld(FPlane.fromFloat, FPlane.fromDouble),
  ],
  [
  ...
  // Rotator
  [
    makeCombinedName(NAME_CoreUObject, "Rotator3f"),
    makeStructReader(FRotator.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Rotator3d"),
    makeLargeWorld(FRotator.fromFloat, FRotator.fromDouble),
  ],
  [
  ...
  // FBox
  [
    makeCombinedName(NAME_CoreUObject, "Box3f"),
    makeStructReader(FBox.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Box3d"),
    makeLargeWorld(FBox.fromFloat, FBox.fromDouble),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Box"),
    makeLargeWorld(FBox.fromFloat, FBox.fromDouble),
  ],

  // Matrix44
  [
    makeCombinedName(NAME_CoreUObject, "Matrix44f"),
    makeStructReader(FMatrix44.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Matrix44d"),
    makeLargeWorld(FMatrix44.fromFloat, FMatrix44.fromDouble),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Matrix"),
    makeLargeWorld(FMatrix44.fromFloat, FMatrix44.fromDouble),
  ],

  // Colors
  [
    makeCombinedName(NAME_CoreUObject, "LinearColor"),
    makeStructReader(FLinearColor.fromStream),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Color"),
    makeStructReader(FColor.fromStream),
  ],

  // Quat
  [
    makeCombinedName(NAME_CoreUObject, "Quat4f"),
    makeStructReader(FQuat.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Quat4d"),
    makeLargeWorld(FQuat.fromFloat, FQuat.fromDouble),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Quat"),
    makeLargeWorld(FQuat.fromFloat, FQuat.fromDouble),
  ],

  // TwoVectors
  [
    makeCombinedName(NAME_CoreUObject, "TwoVectors"),
    makeLargeWorld(FTwoVectors.fromFloat, FTwoVectors.fromDouble),
  ],

  // Transform
  [
    makeCombinedName(NAME_CoreUObject, "Transform3f"),
    makeStructReader(FTransform.fromFloat),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Transform3d"),
    makeStructReader(FTransform.fromDouble),
  ],
  ...
  // Date and time
  [
    makeCombinedName(NAME_CoreUObject, "DateTime"),
    makeStructReader(FDateTime.fromStream),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "Timespan"),
    makeStructReader(FTimespan.fromStream),
  ],
  [
    makeCombinedName(NAME_CoreUObject, "FrameNumber"),
    makeStructReader(FFrameNumber.fromStream),
  ],

  // Soft class reference
  [
    makeCombinedName(NAME_CoreUObject, "SoftObjectPath"),
    softObjectPathSerializer,
  ],
  [
    makeCombinedName(NAME_CoreUObject, "SoftClassPath"),
    softObjectPathSerializer,
  ],
]);
...
function taggedPropertiesSerializer(
  reader: AssetReader,
  resolver: ObjectResolver,
): PropertyValue {
...
function getStructSerializer(
  ...
  const newVar = findNativeStructSerializer(
    fileVersionUE5,
    outer.name,
    structName.name,
  );
