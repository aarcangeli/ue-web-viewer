...
export const FUE5ReleaseStreamObjectVersionDetails: VersionDetails[] = [
  ...
  new VersionDetails({
    name: "AnimLayeredBoneBlendMasksFix",
    comment: "Fix a bug where BlendMask counts could get out of sync with BlendPose counts.",
    value: 52,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "BloomIndependentLensFlare",
    comment: "Separated lens flare from bloom intensity",
    value: 53,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "AnimModelGuidGenerationSettings",
    comment: "Add settings to IAnimationDataModel GUID generation",
    value: 54,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "WorldPartitionAddStandaloneHLODSupport",
    comment: "Add support for Standalone HLOD",
    value: 55,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "RecalculateClothAssetSerializedBounds",
    comment: "Fixed the missing bounds for cloth assets that don't have them serialized",
    value: 56,
    firstAppearance: "5.6.0",
  }),
];

export const FUE5ReleaseStreamObjectVersionGuid = new CustomVersionGuid<FUE5ReleaseStreamObjectVersion>({
  friendlyName: "UE5-Release",
  guid: FGuid.fromComponents(0xd89b5e42, 0x24bd4d46, 0x8412aca8, 0xdf641779),
  details: FUE5ReleaseStreamObjectVersionDetails,
});
