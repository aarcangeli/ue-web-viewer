...
export const FMovieSceneEvaluationCustomVersionGuid = new CustomVersionGuid<FMovieSceneEvaluationCustomVersion>({
  friendlyName: "MovieSceneEvaluation",
  guid: FGuid.fromComponents(0xa462b7ea, 0xf4994e3a, 0x99c1ec1f, 0x8224e1b2),
  details: FMovieSceneEvaluationCustomVersionDetails,
});
