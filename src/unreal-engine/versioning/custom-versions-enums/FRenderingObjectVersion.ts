...
export enum FRenderingObjectVersion {
  ...
  DeprecatedHighResSourceMesh = 49,
  // endregion
}
...
export const FRenderingObjectVersionDetails: VersionDetails[] = [
  ...
  new VersionDetails({
    name: "DeprecatedHighResSourceMesh",
    comment: "Do not serialize deprecated high res source mesh",
    value: 49,
    firstAppearance: "5.5.0",
  }),
];

export const FRenderingObjectVersionGuid = new CustomVersionGuid<FRenderingObjectVersion>({
  friendlyName: "Dev-Rendering",
  guid: FGuid.fromComponents(0x12f88b9f, 0x88754afc, 0xa67cd90c, 0x383abd29),
  details: FRenderingObjectVersionDetails,
});
