...
export const FAssetRegistryVersionDetails: VersionDetails[] = [
  ...
  new VersionDetails({
    name: "AssetPackageDataHasPackageLocation",
    comment: "Added Extension to AssetPackageData.",
    value: 18,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "MarshalledTextAsUTF8String",
    comment: "Added PackageLocation to AssetPackageData.",
    value: 19,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "PackageSavedHash",
    comment: "Replaced 2 byte wide string with UTF8 String",
    value: 20,
    firstAppearance: "5.6.0",
  }),
  new VersionDetails({
    name: "ExternalActorToWorldIsEditorOnly",
    comment: "Replaced FAssetPackageData::PackageGuid with PackageSavedHash",
    value: 21,
    firstAppearance: "5.6.0",
  }),
];

export const FAssetRegistryVersionGuid = new CustomVersionGuid<FAssetRegistryVersion>({
  friendlyName: "AssetRegistry",
  guid: FGuid.fromComponents(0x717f9ee7, 0xe9b0493a, 0x88b39132, 0x1b388107),
  details: FAssetRegistryVersionDetails,
});
