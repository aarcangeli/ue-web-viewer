...
export const PACKAGE_CoreUObject = new UPackage(
  LazyClass,
  FName.fromString("/Script/CoreUObject"),
);

export const CLASS_Object = new UClass(
  LazyClass,
  FName.fromString("Object"),
  null,
);
export const CLASS_Class = new UClass(
  LazyClass,
  FName.fromString("Class"),
  CLASS_Object,
);
export const CLASS_Package = new UClass(
  CLASS_Class,
  FName.fromString("Package"),
  null,
);
...
export const UnknownClass = new UClass(
  CLASS_Class,
  FName.fromString("[Unknown Class]"),
  null,
);
export const UnknownObject = new UObject(
  UnknownClass,
  FName.fromString("[Unknown Object]"),
);
